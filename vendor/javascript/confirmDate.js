      ...
      return __assign(
        {
          ...
          onReady: function () {
            ...
            confirmContainer.innerHTML += `<span class="mx-1">${config.confirmIcon}</span> <span class="mx-1">${config.confirmText}</span>`
            confirmContainer.addEventListener("click", (e) => {
              this.fpBtnConfirmed = true
              fp.close()
            })
