...
function FlatpickrInstance(a, r) {
  ...
  function init() {
    ...
    if (u.selectedDates.length || u.config.noCalendar) {
      u.config.enableTime &&
        setHoursFromDate(u.config.noCalendar ? u.latestSelectedDateObj : void 0)
      updateValue(false)
    }
    setCalendarWidth()
  ...
  function buildDays() {
    if (void 0 !== u.daysContainer) {
      ...
      "range" === u.config.mode && 1 === u.selectedDates.length && onMouseOver()
    }
  }
  ...
  function buildTime() {
    ...
    if (u.config.enableSeconds) {
      ...
      u.secondElement.setAttribute("step", u.minuteElement.getAttribute("step"))
  ...
  function updateValue(e) {
    ...
    void 0 !== u.altInput && (u.altInput.value = getDateStr(u.config.altFormat))
